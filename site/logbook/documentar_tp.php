<?php
	...
	while( $data = $result->fetch_assoc() ){
		...
		$tabla .= 	"<td>".$data['usr']."</td>";
		$tabla .= 	"<td align='center'>".$data['INGRESO']."</td>";
		$tabla .= 	"<td>".$data['DESCRIPCION']."</td>";
		$tabla .= 	"<td align='center'><input id='$chk_id' name='$chk_id' type='checkbox' value='".$data['ID']."'></td>";
		$tabla .= "</tr>";
	}
	
	$result = $cCfn->exeQuery("doc_bit_tipo",null,null,$cCfn->getLocal(),null,$modulo);
	...
	<input type="hidden" name="registros" id="registros" value="<?php echo $r; ?>" />
