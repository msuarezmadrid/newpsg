<?php
	...
	$tipo = isset($_GET["tipo"]) ? $_POST["tipo"] : null; ?>
	...
	if ( $cCfn->checkProfile("ProfileOperadorRed") || $cCfn->checkProfile("om_test") ){ ?>
		...
		<p><a href='crear_bitacora_opersis.php'>Operadores VAS</a></p>
		<p><a href='crear_bitacora_gsm.php'>Operadores GSM/WCDMA</a></p>
		<p><a href='crear_bitacora_plran.php'>Primera l&iacute;nea RAN </a></p>
		<p><a href='crear_bitacora_fallas.php?op=1'>CORE Telefon&iacute;a Fija</a></p>
		<p><a href='crear_bitacora_fallas.php?op=2'>NOC IP</a></p>
		<p><a href='crear_bitacora_fallas.php?op=3'>NOC Transporte</a></p>
